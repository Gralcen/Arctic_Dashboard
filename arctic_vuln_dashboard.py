...
data = {
    ...
    "Risk-Adjusted Score": [73.66, 63.5, 32.85, 40.64, 57.15, 64.77, 68.58, 55.88, 54.61, 66.04, 60.96, None],
...
fig_bar = px.bar(df, x="Country", y=score_type, color=score_type,
                 color_continuous_scale="Oranges", title=f"{score_type}")
st.plotly_chart(fig_bar)

# Map visualization (excluding China due to ISO3 limitation)
st.subheader("Map: Risk-Adjusted Score")
map_data = df.dropna(subset=["Risk-Adjusted Score"]).copy()
