...
data = {
    ...
    "Base Score": [58.0, 50.0, 45.0, 32.0, 45.0, 51.0, 54.0, 44.0, 43.0, 52.0, 48.0, 62.0, 45.0],
    "Risk-Adjusted Score": [73.66, 63.5, 32.85, 40.64, 57.15, 64.77, 68.58, 55.88, 54.61, 66.04, 60.96, 0, 57.15],
    "Net Readiness": [59.0, 73.0, 81.0, 74.0, 62.0, 60.0, 57.0, 52.0, 63.0, 58.0, 60.0, 66.0, 62.0]
}
